		...
		<section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
			<div className="text-center">
				<div className="mb-6 sm:mb-8">
					<Image src={portrait} alt="Profile Picture" width={260} height={260} className="rounded-full mx-auto border-4 border-gray-700 shadow-lg" />
				</div>
				...
				<p className="text-gray-400 max-w-2xl mx-auto text-sm sm:text-base px-4">
					With 7+ years of professional experience as a Software Developer and an additional 3+ years experience in a variety of technical and geo related fields I bring a unique perspective 
